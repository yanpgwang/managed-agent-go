...
| Skills, memory, and vaults | Not supported | These product surfaces remain outside the core harness scope. Inline or URL image/document content still participates in the provider transcript and context projection. |
