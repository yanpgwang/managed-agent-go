...
| [Sandbox adapters](sandboxes.md) | Limited / Preview | Local and Docker are available. E2B, CubeSandbox, OpenSandbox, and Daytona have durable bindings; OpenSandbox and Daytona materialize File Resources through their official SDKs with a documented writable-copy limitation. Remote adapters remain Preview pending repeated live conformance and production routing policy. |
