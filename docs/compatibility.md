...
| Vaults | Not supported | Vault and credential surfaces remain outside the current harness scope. Inline or URL image/document content still participates in the provider transcript and context projection. |
