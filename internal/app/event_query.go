...
// EventQuery expresses the public List Events filters. Mango retains the
// created_at query name from its original surface but applies those filters,
// ordering, and pagination to the event processed_at value.
