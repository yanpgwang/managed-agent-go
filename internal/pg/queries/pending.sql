...
VALUES (
    @id, @session_id, @action_event_id, @kind, NULL, @created_at, NULL
);
...
WHERE session_id = @session_id AND action_event_id = @action_event_id
FOR UPDATE;
...
WHERE session_id = @session_id
  AND action_event_id = @action_event_id
